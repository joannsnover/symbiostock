...
<div id="symbiostock_display_preview" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body"><div class="modal-preview symbiostock_loader"><img class="img-responsive" onload="$(this).fadeIn();" id="search_selection_symbiostock_preview" alt="Image Preview" src="<?php echo symbiostock_IMGDIR . '/loading-large.gif' ?>" /></div>
                <table class="table">
                    <thead>
                        <tr>
                            <th> Size </th>
            ...
            <div class="modal-footer">
                <a data-toggle="tooltip" class="modal_control ssref" id="search_selection_permalink" title="Go to image page..." href="#"><i class="icon-share-alt"> &nbsp;</i></a>
