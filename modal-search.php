        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 id="search_selection_title">Modal Header</h3>
                 <p><?php _e('By', 'symbiostock') ?> <span id="search_selection_author"><?php _e('Somone', 'symbiostock') ?></span><p>
            </div>
