	...
	<div id="content" class="span9">
		<div class="padder">
			...
			<form action="" method="post" id="forums-search-form" class="dir-form">
				<h3 class="span6"><?php _e( 'Forums Directory', 'buddypress' ); ?><?php if ( is_user_logged_in() ) : ?> &nbsp;<a class="button show-hide-new" href="#new-topic" id="new-topic-button"><?php _e( 'New Topic', 'buddypress' ); ?></a><?php endif; ?></h3>
				<?php do_action( 'bp_before_directory_forums_content' ); ?>
				<div id="forums-dir-search" class="dir-search span6" role="search">
