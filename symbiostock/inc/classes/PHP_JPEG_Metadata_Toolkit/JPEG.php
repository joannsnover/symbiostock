...
function Interpret_Comment_to_HTML( $jpeg_header_data )
{
        ...
        if ( $comment !== FALSE )
        {
                ...
                $output .= "<h4 class=\"JPEG_Comment_Main_Heading\">JPEG Comment</h4>\n";
...
function Interpret_intrinsic_values_to_HTML( $values )
{
        ...
        {
                // Write Heading
                $OutputStr = "<h4 class=\"JPEG_Intrinsic_Main_Heading\">Intrinsic JPEG Information</h4>\n";
                // Create Table
                $OutputStr .= "<table class=\"JPEG_Intrinsic_Table table table-condensed table-bordered\" >\n";
...
function Generate_JPEG_APP_Segment_HTML( $jpeg_header_data )
{
        ...
        // Write Heading
        $output = "<h4 class=\"JPEG_APP_Segments_Main_Heading\">Application Metadata Segments</h4>\n";
        // Create table
        $output .= "<table class=\"JPEG_APP_Segments_Table table table-condensed table-bordered\" >\n";
