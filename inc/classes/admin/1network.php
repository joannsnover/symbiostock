        ...
        <table id="your_site_info"  class="widefat form-table symbiostock-settings">
            ...
            <tr>
             ...
             <tr>
                ...
                <td><textarea class="longfield" name="symbiostock_my_network_announcement"  id="symbiostock_my_network_announcement" ><?php echo stripcslashes ( get_option('symbiostock_my_network_announcement', '')) ?></textarea><br />
                Real-time announcement regarding your site. Running a discount? Offering custom work?
                </td>
            </tr>
            ...
            <tr>
                ...
                <br />URL to Avatar you upload in <a title="Media Area" href="/wp-admin/upload.php">Media area</a>. <em>Must be <strong>32 × 32 px</strong> or it will not validate.</em>
                </td>
            </tr>
            <tr>
                ...
                <br />URL to Logo you upload in <a title="Media Area" href="/wp-admin/upload.php">Media area</a>. <em>Must be <strong>128 × 128 px</strong> or it will not validate.</em>
                </td>
            </tr>   
            <tr>
                ...
                <br />Make an awesome about page and post the URL here.
                </td>
            </tr>   
...
<div>
<span id="save_changes" href="#">&nbsp;</span>
<?php } else { 
	
	$ssnet_yes = '';
	$ssnet_no = 'checked="checked"';
	?> <br /><a target="_blank" title="Symbiostock Updates" href="http://www.symbiostock.com"> <img title="Symbiostock Updates" src="<?php echo symbiostock_LOGOSMALL; ?>" /> </a> <?php
    ...
    <label for="symbiostock_use_network_1"><input id="symbiostock_use_network_1" type="radio" name="symbiostock_use_network" value="true" <?php echo $ssnet_yes; ?> />Activate</label><br />
    <label for="symbiostock_use_network_2"><input id="symbiostock_use_network_2" type="radio" name="symbiostock_use_network" value="false" <?php echo $ssnet_no; ?> />Deactivate</label>
    </p>