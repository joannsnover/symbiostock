...
class symbiostock_front_ajax{
	...
	function __construct(){
		...
		add_action('wp_ajax_nopriv_symbiostock_process',  array( &$this, 'process' ) ); // executed when logged out
		...
		public function process(){
			...
			if(isset($_POST['symbiostock_network_query'])){
				...
				$network_results->network_page_query($_POST['symbiostock_network_query']);
