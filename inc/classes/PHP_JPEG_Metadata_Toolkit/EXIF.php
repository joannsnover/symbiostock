...
function Interpret_EXIF_to_HTML( $Exif_array, $filename )
{
        ...
        {
                $output_str .= "<h4 class=\"EXIF_Main_Heading\">Contains Exchangeable Image File Format (EXIF) Information</h4>\n";
        }
        else if ( $Exif_array[ 'Tags Name' ] == "Meta" )
        {
                $output_str .= "<h4 class=\"EXIF_Main_Heading\">Contains META Information (APP3)</h4>\n";
        }
        else
        {
                $output_str .= "<h4 class=\"EXIF_Main_Heading\">Contains " . $Exif_array[ 'Tags Name' ] . " Information</h4>\n";
        }
        ...
        $output_str .= "<h4 class=\"EXIF_Secondary_Heading\">Main Image Information</h4>\n";
        ...
        if ( array_key_exists( 1, $Exif_array ) )
        {
                ...
                $output_str .= "<h4 class=\"EXIF_Secondary_Heading\">Thumbnail Information</h4>\n";
        ...
        while ( array_key_exists( $i, $Exif_array ) )
        {
                ...
                $output_str .= "<h4  class=\"EXIF_Secondary_Heading\">Image File Directory (IFD) $i Information</h4>\n";
                // Interpret the IFD to html and add it to the output
...
function interpret_IFD( $IFD_array, $filename )
{
        ...
        $output_str = "<table class=\"EXIF_Table table table-condensed table-bordered\">\n";
             ...
             ( ! array_key_exists( 37500, $IFD_array ) ) )
        {
                ...
                $extra_IFD_str .= "<h4 class=\"EXIF_Secondary_Heading\">No Makernote Present</h4>";
        }
        ...
        foreach( $IFD_array as $Tag_ID => $Exif_Tag )
        {
                ...
                else if ( $Exif_Tag['Decoded'] == TRUE )
                {
                        ...
                        if ( $Exif_Tag['Type'] == "SubIFD" )
                        {
                                ...
                                $extra_IFD_str .= "<h4 class=\"EXIF_Secondary_Heading\">" . $Exif_Tag['Tag Name'] . " contents</h4>";
                        ...
                        else if ( $Exif_Tag['Type'] == "Maker Note" )
                        {
                                ...
                                $extra_IFD_str .= "<h4 class=\"EXIF_Secondary_Heading\">Maker Note Contents</h4>";
                        ...
                        else if ( $Exif_Tag['Type'] == "IPTC" )
                        {
                                ...
                                $extra_IFD_str .= "<h4 class=\"EXIF_Secondary_Heading\">Contains IPTC/NAA Embedded in EXIF</h4>";
                        ...
                        else if ( $Exif_Tag['Type'] == "XMP" )
                        {
                                ...
                                $extra_IFD_str .= "<h4 class=\"EXIF_Secondary_Heading\">Contains XMP Embedded in EXIF</h4>";
                        ...
                        else if ( $Exif_Tag['Type'] == "IRB" )
                        {
                                ...
                                $extra_IFD_str .= "<h4 class=\"EXIF_Secondary_Heading\">Contains Photoshop IRB Embedded in EXIF</h4>";
                ...
                else
                {
                        ...
                        else if ( $Exif_Tag['Type'] == "Maker Note" )
                        {
                                ...
                                $extra_IFD_str .= "<h4 class=\"EXIF_Secondary_Heading\">Makernote Coding Unknown</h4>\n";
                        }
                        else
                        {
