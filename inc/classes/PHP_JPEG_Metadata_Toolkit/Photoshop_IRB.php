...
function Interpret_IRB_to_HTML( $IRB_array, $filename )
{
        ...
        if ( $IRB_array !== FALSE )
        {
                ...
                $output_str .= "<h4 class=\"Photoshop_Main_Heading\">Contains Photoshop Information Resource Block (IRB)</h4>";
                // Add Table to the HTML
                $output_str .= "<table class=\"Photoshop_Table table table-condensed table-bordered\" >\n";
