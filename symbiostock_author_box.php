...
// jas 2013-12-08 add rel ="author" h-card and fn for Google+ authorship
// jas 2013-10-25 compact the author bio box on the image page a bit
...
<!-- jas begin Stack author name and drop down on left of bio box with avatar on right - to reduce the overall space this takes up; add class h-card to author link and fn to name-->
